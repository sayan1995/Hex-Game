...
public class DepthFirstSearch
{
    ...
    // These arrays are used to get row and column numbers of 6 neighbors of a given cell
...
// The main function that returns count of islands in a given boolean 2D matrix
    ...
    for (i = 0; i < 11; ++i)
        for (j = 0; j < 11; ++j)
            if (M[i][j]==player && !visited[i][j]) // If a cell with value 1 is not visited yet, then new node found
            {                              
